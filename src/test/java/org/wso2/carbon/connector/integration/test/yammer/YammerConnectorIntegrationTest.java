...
public class YammerConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void testGetMessagesWithMandatoryParameters() throws IOException, JSONException, InterruptedException {
        ...
        final JSONArray esbResponseArray = esbRestResponse.getBody().getJSONArray("messages");
        final JSONArray apiResponseArray = apiRestResponse.getBody().getJSONArray("messages");
     ...
     */
    @Test(groups = { "wso2.esb" }, enabled = true,description = "yammer {postLike} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },enabled = true, description = "yammer {getAboutAUser} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, enabled = true,description = "yammer {getByGroup} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },enabled = true, description = "yammer {getTopicById} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },enabled = true, description = "yammer {joinGroup} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },enabled = true, description = "yammer {leaveGroup} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" },enabled = true, description = "yammer {getSubUser} integration test with negative case.")
